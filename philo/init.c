...
/*   Updated: 2024/10/09 12:30:17 by brsantsc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init(t_data *data, int argc, char **argv)
{
	...
	if (argc == 6)
		...
		data->must_eat = -1;
	data->philos = memory_allocation(sizeof(t_philo) * data->nbr_of_philos);
	data->forks = memory_allocation(sizeof(pthread_mutex_t)
			* data->nbr_of_philos);
	data->threads = memory_allocation(sizeof(pthread_t) * data->nbr_of_philos);
	i = 0;
